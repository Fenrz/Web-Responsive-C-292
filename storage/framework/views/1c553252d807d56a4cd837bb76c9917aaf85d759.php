            ...
            <div class="col-lg-4">
                <div class="card mt-5">
                    ...
                    <div class="card-body"></div>
                        <form method="POST" action="<?php echo e(route('simpanuser')); ?>" class ="mb-5">
                            <?php echo csrf_field(); ?>
                            ...
                            <small class ="m-3">Sudah punya akun?<a href="/login"> Login<a> sekarang</a></a> </small>
                        </form>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-tugasWR\resources\views/user/register.blade.php ENDPATH**/ ?>